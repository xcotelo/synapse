...
// Descarga una sola nota como archivo .md (tecla D en todos los elementos de conocimiento)
...
// Descarga el documento original (el archivo subido) cuando la nota tiene media.url
